...
class AccelerationLineChartPage extends StatefulWidget {
  const AccelerationLineChartPage({super.key});

  @override
  _AccelerationLineChartPage createState() => _AccelerationLineChartPage();
}

class _AccelerationLineChartPage extends State<AccelerationLineChartPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Acceleration Mean', style: TextStyle(color: Colors.black)),
